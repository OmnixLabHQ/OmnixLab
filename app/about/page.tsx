            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              ...
              <div>
                ...
                <p className="text-xl text-gray-500 mb-4">
                  Building a Global Software Development Company
                </p>
                <p className="text-gray-600 leading-relaxed max-w-2xl mb-6">
                  Akomolafe Nathaniel is the visionary Founder and CEO of{" "}
                  <strong>Omnix Lab</strong>, a global software development
                  company. With over 4 years of expertise in software
                  engineering, he has personally led the delivery of{" "}
                  <strong>50+ successful projects</strong> for clients across
                  10+ countries, earning a{" "}
                  <strong>99% client satisfaction rate</strong>.
                </p>
                <div className="flex flex-wrap gap-3">
                  <Link
                    href="/contact"
                    className="inline-flex px-6 py-3 bg-indigo-600 text-white font-semibold rounded-full hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-200"
                  >
                    Work With Me →
                  </Link>
                  <a
                    ...
                    className="inline-flex px-6 py-3 border-2 border-gray-200 text-gray-700 font-semibold rounded-full hover:border-indigo-300 transition-colors"
                  >
                    💬 WhatsApp
                  </a>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Omnix Lab was founded with a singular mission: to provide
                  world-class software development services that rival any global
                  agency. Under the leadership of Akomolafe Nathaniel, we have
                  grown from a solo development studio to a full-service
                  software company serving clients across Africa, Europe, North
                  America, and Asia.
                </p>
                <p className="text-gray-600 leading-relaxed mb-4">
                  We specialize in{" "}
                  <strong>trading bot development</strong>,{" "}
                  <strong>enterprise web applications</strong>,{" "}
                  <strong>SaaS platforms</strong>,{" "}
                  <strong>mobile applications</strong>, and{" "}
                  <strong>AI solutions</strong>. Every project is built with
                  enterprise-grade architecture, clean code, and a focus on
                  measurable business results.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  With a <strong>99% client satisfaction rate</strong> and{" "}
                  <strong>50+ projects delivered</strong>, Omnix Lab has
                  established itself as the go-to development partner for
                  businesses seeking premium digital solutions.
                </p>
              </div>
                ...
                {[
                  {
                    icon: '🎯',
                    title: 'Our Mission',
                    desc: 'Empower businesses worldwide with cutting-edge technology solutions that drive measurable growth.',
                  },
                  {
                    icon: '🔮',
                    title: 'Our Vision',
                    desc: 'Become the #1 software development company recognized globally for technical excellence.',
                  },
                  {
                    icon: '💎',
                    title: 'Our Values',
                    desc: 'Quality, transparency, innovation, and client success above everything else.',
                  },
                  {
                    icon: '🌍',
                    title: 'Our Reach',
                    desc: 'Serving clients in 10+ countries with remote-first collaboration and 24/7 support.',
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="bg-gradient-to-br from-gray-50 to-indigo-50 p-5 rounded-2xl border border-gray-100"
                  >
              ...
              {[
                {
                  ...
                  desc: 'Every project receives personal attention from our Founder & CEO, Akomolafe Nathaniel. No project is delegated to junior developers without senior oversight.',
                },
                {
                  title: 'Enterprise-Grade Quality',
                  desc: 'We use battle-tested technologies and follow rigorous testing protocols. Our code is clean, documented, and built to scale to millions of users.',
                },
                {
                  title: '100% Transparency',
                  desc: 'Weekly progress updates, direct communication channels, and access to project management tools. You always know exactly where your project stands.',
                },
                {
                  title: 'On-Time Delivery',
                  desc: 'We commit to realistic timelines and deliver on schedule. 50+ projects completed without a single missed deadline.',
                },
                {
                  title: 'Post-Launch Support',
                  desc: '30 days of free support after launch. Extended maintenance packages available for ongoing optimization and updates.',
                },
                {
                  title: 'Global Standards',
                  desc: 'GDPR-ready, HIPAA-compliant, and built to international standards. Our solutions work seamlessly across all regions.',
                },
              ].map((item, i) => (
                <div
                  key={i}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {[
                ...
                <div
                  key={i}
                  className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-5 text-center border border-gray-100 hover:border-indigo-200 hover:shadow-md transition-all cursor-default"
                >
        ...
        <section className="py-24 lg:py-32 px-6 lg:px-8 bg-gradient-to-br from-indigo-600 to-purple-600 text-white">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-indigo-100 text-lg mb-8">
              Join 15+ businesses worldwide that trust Omnix Lab for their
              software development needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className="inline-flex px-8 py-4 bg-white text-indigo-600 font-semibold rounded-full hover:bg-gray-100 transition-colors shadow-xl"
              >
                Start Your Project →
              </Link>
              <a
