...
export default function AdminProjectDetailPage() {
  ...
  try {
    ...
    console.log('Saving progress:', newProgress, 'for project:', project.id)
    ...
    alert('Progress set to ' + newProgress + '%')
    setShowProgressOverride(false)
    setFormProgress('')
    
    // Force reload the entire project data
